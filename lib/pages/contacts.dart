...
class _ContactsPageState extends State<ContactsPage> {
  ...
  List<DocumentSnapshot> contactsData;
  @override
  void initState() {
    ...
    super.initState();
    _getCurrentUser();
    fetchcontact().then((onValue) {
      setState(() {
        contactsData = onValue;
      });
    });
  }

  Future<List<DocumentSnapshot>> fetchcontact() async {
      ...
      return Scaffold(
          ...
          body: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                if (txtSearchContact == "") {
                  return _buildListItem(context, contactsData[index]);
                } else {
